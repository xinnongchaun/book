...
import com.js.dao.BookTypeDao;
import com.js.model.Book;
import com.js.model.BookType;
...
public class BookManageInterFrm extends JInternalFrame {
	...
	public BookManageInterFrm() {
		...
		JButton btnNewButton = new JButton("\u6253\u5370\u8BE5\u56FE\u4E66\u4FE1\u606F");
	 ...
	 * 打印图书到指定文件
	 */
	private void PrintBookAction(ActionEvent e) {
		 PrintStream pl = null;
		...
		try {
			pl = new PrintStream(new FileOutputStream("D:/图书信息.txt",true));
		} catch (FileNotFoundException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
	        //写入数据
	        pl.println("编号:"+id+",书名:"+bookName+",作者:"+author+",作者性别:"+sex+",价格"+price+",图书介绍:"+bookDesc);
	        //关闭文件
	        pl.close();
